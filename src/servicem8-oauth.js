...
export const OAUTH_SCOPES = "read_jobs manage_jobs read_job_categories read_customers read_customer_contacts manage_customer_contacts manage_badges publish_sms publish_email read_job_notes vendor";
